...
enum class ResponseStatus(val httpResponseStatus: HttpResponseStatus) {
    CONTINUE(HttpResponseStatus.CONTINUE),
    SWITCHING_PROTOCOLS(HttpResponseStatus.SWITCHING_PROTOCOLS),
    PROCESSING(HttpResponseStatus.PROCESSING),
    ...
    MULTI_STATUS(HttpResponseStatus.MULTI_STATUS),
    ...
    PERMANENT_REDIRECT(HttpResponseStatus.PERMANENT_REDIRECT),
